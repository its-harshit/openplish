...
export function TaskInputBar({
  ...
  return (
    <div className="w-full space-y-2">
      ...
      <div
        className={cn(
          'rounded-[12px] border bg-popover/70 transition-all duration-200 ease-somehow cursor-text focus-within:border-saffron/50 focus-within:ring-1 focus-within:ring-saffron/25',
          isDragOver
